...
?>
    ...
    <body>
        ...
        <form method="get" action="toevoegenklant.php">
            <label>Naam</label>
            <input type="text" name="name" value="<?php print($gegevens['name']); ?>" /> <br>
            <label>Woonplaats</label>
            <input type="text" name="city" value="<?php print($gegevens['city']); ?>" /> <br>
            <label>Adres</label>
            <input type="text" name="address" value="<?php print($gegevens['address']); ?>" /> <br>
            <label>Email</label>
            <input type="text" name="email" value="<?php print($gegevens['email']); ?>" /> <br>
